...
// in the polyfill before the real background script. Keeping background.js
// itself uncopied preserves its line numbers in stack traces.
const SW_ENTRY = 'sw.js';
const SW_SOURCE = `// Generated by scripts/build.mjs — do not edit.\n`
  + `importScripts('${POLYFILL}', 'background.js');\n`;
